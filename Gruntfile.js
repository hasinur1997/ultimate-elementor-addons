module.exports = function(grunt) {
    ...
    concat: {
        options: {
            ...
            ultimate_elementor_addons: {
                src: [
                    'assets/js/vendor/*.js',
                    'assets/js/src/ultimate-elementor-addons.js',
                ],
                    dest: 'assets/js/ultimate-elementor-addons.js'
            }
        },
    // jshint
    jshint: {
    ...
    uglify: {
        all: {
            files: {
                'assets/js/ultimate-elementor-addons.min.js': ['assets/js/ultimate-elementor-addons.js']
            },
            options: {
        ...
        sass:   {
            all: {
                files: {
                    'assets/css/ultimate-elementor-addons.css': 'assets/css/sass/ultimate-elementor-addons.scss'
                }
            }
        },
        ...
        cssmin: {
            ...
            minify: {
                ...
                cwd: 'assets/css/',
                src: ['ultimate-elementor-addons.css'],
            ...
            target: {
                options: {
                    exclude: ['build/.*', 'node_modules/*', 'assets/*'],
                        ...
                        potFilename: 'ultimate-elementor-addons.pot', // Name of the POT file.
      ...
      compress: {
        main: {
            options: {
                mode: 'zip',
                    archive: './build/ultimate-elementor-addons-' + pkg.version + '.zip'
            },
            expand: true,
                cwd: 'build/',
                src: ['**/*'],
                dest: 'ultimate-elementor-addons'
        }
    },
    server: {
        options: {
